...
echo "PID $PID Infos:"
echo "Spent ${PROCESS_UTIME_SEC}s in user mode"
echo "Spent ${PROCESS_STIME_SEC}s in kernel mode"
echo "Total CPU usage is ${PROCESS_USAGE_SEC}s"
echo "Running for ${PROCESS_ELAPSED_SEC}s"
echo "Used ${PROCESS_USAGE}% of CPU"